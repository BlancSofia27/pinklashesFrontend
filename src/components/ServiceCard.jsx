...
const ServiceCard = ({ title, price, description, image }) => {
  return (
    ...
    <div className="flex relative group min-h-full">
      ...
      <div className="relative z-10 px-8 py-10 w-full border-4 border-pink1 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out">
        <h2 className="tracking-widest text-2xl text-pink1 mb-1">
          {title}
        </h2>
        <h1 className="hidden title-font text-2xl font-medium text-gray-900 mb-3">
          {price}
        </h1>
