...
import bunny from '../../public/logoBunny.png'
const FooterLashes = React.forwardRef((props, ref) => {
  return (
    <footer ref={ref} id="footerLashes" className="">
